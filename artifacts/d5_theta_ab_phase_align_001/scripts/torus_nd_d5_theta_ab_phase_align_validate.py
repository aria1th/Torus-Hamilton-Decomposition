#!/usr/bin/env python3
"""Validate saved Theta_AB_plus_phase_align d=5 master-field candidates."""
...
def _print_summary(summary: Dict[str, object], *, use_rich: bool) -> None:
    ...
    for item in summary["validated_fields"][:5]:
        ...
        lines.append(
            ...
            f"collapse={first['old_collapse_law']['matches_old_collapse_law']} "
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate Theta_AB_plus_phase_align master-field candidates.")
