#!/usr/bin/env python3
"""Validate surviving rules from the minimal two-old-bit d=5 family."""
...
def _print_summary(summary: Dict[str, object], *, use_rich: bool) -> None:
    ...
    for row in summary["candidates"][:5]:
        lines.append(
            ...
            f"kind={row['pilot_validation']['overall_kind']} "
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate surviving rules from the minimal two-old-bit d=5 family.")
